...
def ONet(n_classes, input_shape, encoder, activation="softmax"):
	...
	x5 = build_pyramid_pooling_module(B5, input_shape)
	x4 = build_pyramid_pooling_module(B4, input_shape)
	x3 = build_pyramid_pooling_module(B3, input_shape)
	x2 = build_pyramid_pooling_module(B2, input_shape)
	x1 = build_pyramid_pooling_module(B1, input_shape)

	x = concatenate([x5, x4, x3, x2, x1])
